...
cur.execute("""CREATE TABLE IF NOT EXISTS musinsa_table(brand VARCHAR(255), title VARCHAR(255),price VARCHAR(255),riview VARCHAR(255),wishlist VARCHAR(255),link VARCHAR(255),color VARCHAR(255))""")
con.commit()
...
def PageUrl(pageNum):
  ...
  url_2 = '&display_cnt=90&sale_goods=&group_sale=&kids=N&ex_soldout=&color=11&price1=&price2=&exclusive_yn=&shoeSizeOption=&tags=&campaign_id=&timesale_yn=&q=&includeKeywords=&measure='
