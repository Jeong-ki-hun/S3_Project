...
def PageUrl(pageNum):
  ...
  url_2 = '&display_cnt=90&sale_goods=&group_sale=&kids=N&ex_soldout=&color=3&price1=&price2=&exclusive_yn=&shoeSizeOption=&tags=&campaign_id=&timesale_yn=&q=&includeKeywords=&measure='
...
#data = {'브랜드':brand_all, '상품명':title_all,'정상가':price_all,'후기개수':cunt_all,'찜개수':love_all,'링크':link_all,'색상':'white'}
#musinsa_w = pd.DataFrame(data)
#musinsa_w.to_csv('m_gray.csv',index=False,encoding='utf-8')
